...
python3 MIRfix.py --cores ${cores} --families ${location}/Families/MIPF0000159.fa --outdir ${location}/output/ --genomes ${location}/fasta_to_search.txt --mature ${location}/mature_sequences.fa --extension ${extension} --loglevel DEBUG
